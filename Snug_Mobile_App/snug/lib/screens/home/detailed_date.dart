                    ...
                    children: <Widget>[
                                          ...
                                          Padding(
                                              ...
                                              child: Row(
                                                children: <Widget>[
                                                  ...
                                                  Container(
                                                      child: Text(
                                                    _conversion.convertHeight(
                                                        _currentDate.who.ft,
                                                        _currentDate.who.inch),
                                                    style: TextStyle(
                                                        fontSize: 18,
                                                        color: Theme.of(context)
                                                            .dividerColor),
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder:
                                      ...
                                      return new GestureDetector(
                                        onTap: () {
                                          var trustedIndex = "trusted_$index";
                                          launch(
                      ...
                      Container(
                          ...
                          child: RaisedRoundedGradientButton(
                            width:
                                MediaQuery.of(context).size.width * (.95 / 2),
                            child: Text(
                              _converedTimeInDateTime(_currentDate.dateStart)
                            ...
                            onPressed: () async {
                              if (_endStatus == 'Cancel Date') {
                                try {
                                  Map<String, dynamic>
                                      cancelOrMarkSafeResponse =
                                      await RemoteDatabaseHelper.instance
                                          .deleteDate(_currentDate.dateId);
                                  if (cancelOrMarkSafeResponse['status'] ==
                                      true) {
                                    dateProvider.removeDate(someIndex);
                                ...
                                try {
                                  Map<String, dynamic> markSafeResponse =
                                      await RemoteDatabaseHelper.instance
                                          .markDateSafe(_currentDate.dateId);
